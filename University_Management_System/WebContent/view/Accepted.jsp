<%@page import="org.jsp.app.model.dao.DataBaseCnnectionImpl"%>
...
<form action ="updateToConfirm.jsp" method = "POST">
...
<td><input type= "submit" value ="confirmAddmission"></td>
</tr>
<%
}
%>
