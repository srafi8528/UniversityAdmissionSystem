...
<a href="login.jsp" class="right">Logout</a>
  ...
  <form action="programsOffered" method = "POST"> 
  <table>
  <tr>
	<td>Program Name:</td>
	<td>:</td>
  ...
  <tr>
	<td>Description</td>
	<td>:</td>
	<td><input type="text" placeholder="Enter Description" name="description"  required></td>
  </tr>
  <tr>
	<td>Applicant-Eligibility</td>
	<td>:</td>
	<td><input type="text" placeholder="Enter Eligiblity" name="applicantEligibility"  required ></td>
  </tr>
  <tr>
	<td>Duration</td>
	<td>:</td>
	<td><input type="text" placeholder="Enter Duration"  name="duration"  required></td>
  </tr>
   <tr>
	<td>Degree Certificate Offered</td>
	<td>:</td>
	<td><input type="text" placeholder="Enter Offered Certificate" name="degreeCertificateOffered"  required></td>
  </tr>
  <tr>
	<td></td>
	<td></td>
